  ...
  return (
    <form className="reviews__form form" action="#" method="post">
      ...
      <div className="reviews__rating-form form__rating">
        ...
        <input onChange={rateChangeHandle} className="form__rating-input visually-hidden" name="rating" value="4" id="4-stars" type="radio" />
        ...
        <input onChange={rateChangeHandle} className="form__rating-input visually-hidden" name="rating" value="3" id="3-stars" type="radio" />
        ...
        <input onChange={rateChangeHandle} className="form__rating-input visually-hidden" name="rating" value="2" id="2-stars" type="radio" />
        ...
        <input onChange={rateChangeHandle} className="form__rating-input visually-hidden" name="rating" value="1" id="1-star" type="radio" />
